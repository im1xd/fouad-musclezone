...
export const DELIVERY_COMPANIES = [
  { id: 'yalidine', name: 'Yalidine', tracking: 'https://yalidine.app/tracking/' },
  { id: 'zr-express', name: 'ZR Express', tracking: 'https://zrexpress.dz/tracking/' },
  { id: 'maystro', name: 'Maystro Delivery', tracking: 'https://maystro-delivery.com/tracking/' },
  { id: 'procolis', name: 'Procolis', tracking: 'https://procolis.com/tracking/' },
  { id: 'noest', name: 'Noest Express', tracking: 'https://noest.dz/track/' },
  { id: 'other', name: 'أخرى / Autre', tracking: '' },
]
